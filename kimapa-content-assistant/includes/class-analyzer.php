...
class Analyzer
{
    ...
    private function wordpress_checks(\WP_Post $post, array $extraction, array $facts): array
    {
        ...
        return [
            ...
            $this->check('internal_links', $this->has_internal_links($post->post_content), __('Interne Links vorhanden', 'kimapa-content-assistant'), __('Interne Verlinkungen ergänzen.', 'kimapa-content-assistant'), 7, 'warning'),
